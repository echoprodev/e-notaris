                        ...
                        <form method="post" action="{{ route('permohonan.update', $permohonan->id)}}" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_permohonan" id="" class="form-control">
                                    ...
                                    <option value="Pinjaman Bank"{{ $permohonan->jenis_permohonan == 'Pinjaman Bank' ? 'selected' : '' }}>Permohonan Akat Kredit - Pinjaman Bank</option>
                                    <option value="Perjanjian Jual Beli" {{ $permohonan->jenis_permohonan == 'Perjanjian Jual Beli' ? 'selected' : '' }}>Perjanjian Jual Beli</option>
                                    <option value="Perjanjian Sewa" {{ $permohonan->jenis_permohonan == 'Perjanjian Sewa' ? 'selected' : '' }}>Perjanjian Sewa</option>
                                    <option value="Perjanjian Kuasa" {{ $permohonan->jenis_permohonan == 'Perjanjian Kuasa' ? 'selected' : '' }}>Perjanjian Kuasa</option>
                                    <option value="Sertifikat Jual Beli" {{ $permohonan->jenis_permohonan == 'Sertifikat Jual Beli' ? 'selected' : '' }}>Sertifikat Jual Beli</option>
                                    <option value="Sertifikat Hibah" {{ $permohonan->jenis_permohonan == 'Sertifikat Hibah' ? 'selected' : '' }}>Sertifikat Hibah</option>
                                    <option value="Sertifikat APHB" {{ $permohonan->jenis_permohonan == 'Sertifikat APHB' ? 'selected' : '' }}>Sertifikat APHB (Akta Pembagian Hak Bersama)</option>
                                </select>
                            </div>
                            <div class="form-group">
