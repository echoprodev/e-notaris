                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button class="btn btn-primary btn-round ml-auto">
                                        ...
                                        <a href="{{ route('permohonan.add') }}" class="text-white">Tambah Data
                                            Permohonan</a>
                                    </button>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($data->status == 'Disetujui')
                                                            ...
                                                            {{-- <a href="{{ route('permohonan.cetak') }}"
                                                                class="text-white btn btn-primary btn-sm"><i class="fa fa-print"
                                                                style="width: 10px"></i></a> --}}
                                                        @elseif ($data->status == 'Direvisi')
                                                            {{-- Action Edit --}}
                                                        ...
                                                        {{-- Action Delete --}}
                                                        <form action="{{ route('permohonan.delete', $data->id) }}"
